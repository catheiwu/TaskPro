...
-->
 ...
 ## Installation/Usage
1) Clone this GitHub repository by copying the hyperlink from the green "code" button on the upper right (code-->local-->https) into the following command: git clone --recursive &lt Repo URL &gt
